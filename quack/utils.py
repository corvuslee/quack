...
def filter_results(results: List[Dict[str, str]], min_title_length: int = 3) -> List[Dict[str, str]]:
    """
    ...
    for result in results:
        ...
        if href is None or not (href.startswith('http://') or href.startswith('https://')):
            continue
